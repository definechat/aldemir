          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:items-center relative z-10">
            ...
            <div className="space-y-4 lg:col-span-7">
              ...
              <p className="text-slate-300 text-xs md:text-sm leading-relaxed">
                A <strong>INTERNET ILIMITADA</strong> foi desenhada para romper com as amarras das operadoras tradicionais brasileira. Reunimos em uma única assinatura corporativa simplificada conectividade estável extrema, clube de vantagens reais com retorno financeiro ativo e atendimento VIP sem robozinho.
              </p>
            </div>
