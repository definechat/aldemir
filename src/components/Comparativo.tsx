      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3.5 mb-14">
          ...
          <p className="text-slate-600 text-sm md:text-base leading-relaxed">
            Compare os problemas crônicos dos planos oferecidos diretamente pelas operadoras com as vantagens exclusivas do modelo associativo inovador da INTERNET ILIMITADA.
          </p>
        </div>
              ...
              <thead>
                <tr className="border-b border-slate-100 bg-slate-50">
                  ...
                  <th className="p-4 sm:p-6 text-xs font-bold uppercase tracking-wider text-brand-600 bg-brand-50/30 w-3/8 flex items-center gap-1.5 font-sans">
                    <img src="https://i.imgur.com/XkjH9IQ.png" alt="INTERNET ILIMITADA" className="h-5 w-auto object-contain inline-block" referrerPolicy="no-referrer" /> INTERNET ILIMITADA
                  </th>
                </tr>
              </thead>
